...
import com.mirror.zzyl.common.utils.ConvertHandler;
 ...
 */
@Data
@ApiModel(value = "分页数据消息体",description = "分页数据同一对象")
@Builder
...
public class PageResponse<T> {
     ...
     *
     * @param content 原数据类型
     * @param clazz 转换为的数据类型
     * @param convertHandler 特殊类型转换器
     * @param <T> 转换后的数据类型
     * @param <O> 原数据类型
     * @return 转换为当前数据类型的 list
     */
